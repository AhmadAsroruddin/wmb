                ...
                <div className="row row-cols-1 row-cols-md-4 justify-content-center g-4">
                    <div className="col">
                        <div className="card h-100 border-0 shadow">
                            <img
                                ...
                                className="card-img-top rounded-4 bg-primary" alt="budi"/>
                            <div className="card-body">
                                <blockquote className="blockquote mb-0">
                                    <p>Berbelanja di Enigma Shop selalu menjadi pilihan utama
                                        saya. Produknya lengkap dan kualitasnya top!</p>
                    ...
                    <div className="col">
                        <div className="card h-100 border-0 shadow">
                            ...
                            <div className="card-body">
                                <blockquote className="blockquote mb-0">
                                    <p>Beli kebutuhan bulanan jadi lebih mudah dan cepat. Harganya
                                        juga oke banget.</p>
